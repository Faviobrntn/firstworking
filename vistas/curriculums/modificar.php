                ...
                <div class="card-body mt-2 px-lg-5 pt-0">
                    <form>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div class="input-group">
                                    ...
                                    <input id="title" name="title" value="<?php $title?>" type="text" aria-describedby="materias_aprobadasHelpBlock" required="required" class="form-control">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div class="input-group">
                                    ...
                                    <input id="materias_aprobadas" name="materias_aprobadas" value="<?php $materias_aprobadas?>" type="text" aria-describedby="materias_aprobadasHelpBlock" required="required" class="form-control">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div class="input-group">
                                    ...
                                    <input id="promedio" name="promedio" value="<?php $promedio?>" type="text" class="form-control" aria-describedby="promedioHelpBlock" required="required">
                                </div>
                        ...
                        <label for="conocimientos" class="col-3 col-form-label">Conocimientos</label>
                            <div class="col-9">
                                <textarea id="conocimientos" name="conocimientos" value="<?php $conocimientos?>" cols="40" rows="10" class="form-control"></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <textarea id="experiencia_laboral" name="experiencia_laboral" value="<?php $experiencia_laboral?>" cols="40" rows="10" class="form-control"></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <textarea id="objetivos" name="objetivos" value="<?php $objetivos?>" cols="40" rows="5" class="form-control" aria-describedby="objetivosHelpBlock"></textarea>
